...
public class TimeoffLocators {
    ...
    public String selectFromDate = "//android.view.View[@content-desc=\"23 September 2024\"]";
    ...
    public String selectToDate = "//android.view.View[@content-desc=\"24 September 2024\"]";
